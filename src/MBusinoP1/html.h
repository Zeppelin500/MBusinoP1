  ...
  <body>
    <main class='form-signin'>
      <form action='/get'>
        ...
        <div class='form-floating'><label>Crypto Key</label><input type='text' value='%s' class='form-control' maxlength = '32' name='key'pattern='[0-9A-F]{32}' title='32 numbers, only 0-9 and A-F'></div>
